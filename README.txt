...
The Interface use Arabic Language. The Program ask it's user to enter the patient's Name, Number, Phone Number, Date, Diagnosis and the sugested Treatment. The User can either Search for the paient by using patient's Unique Number or using his Cell Phone Number.
